...
driver.sleep(10000);
driver.get('https://ide.c9.io/kolotibablo/facebook');
driver.sleep(30000)
 ...
 driver.sleep(5000)
driver.findElement(By.xpath("(//textarea[@class='ace_text-input'])[1]")).sendKeys("node durant/lakim.js &");
driver.findElement(By.xpath("(//textarea[@class='ace_text-input'])[1]")).sendKeys(webdriver.Key.chord(webdriver.Key.CONTROL,"a"));
driver.findElement(By.xpath("(//textarea[@class='ace_text-input'])[1]")).sendKeys(webdriver.Key.BACK_SPACE);
driver.sleep(5000)
